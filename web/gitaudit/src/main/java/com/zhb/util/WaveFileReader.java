...
//            }
    ...
    public static void main(String []args) {
        WaveFileReader waveFileReader = new WaveFileReader("D:\\download\\浙江台wav\\XX1201826835999.wav");
        float duration = waveFileReader.getDataLen();
        duration = duration / waveFileReader.getSampleRate();
