    ...
    return{
        ...
        bindEvent: function() {
            $("#print").on("click", function() {
                var url = "printOriginalReport?id=" + Global.reportId;
        ...
        renderModuleRecords: function(response) {
            for (var i = 0; i < response.report.moduleRecords.length; i ++) {
                var moduleRecord = response.report.moduleRecords[i];
        ...
        renderDiscoveries: function(response) {
            for (var i = 0; i < response.report.discoveries.length; i ++) {
                var discovery = response.report.discoveries[i];
