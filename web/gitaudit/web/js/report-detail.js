...
var ReportDetail = function(){
    ...
    return{
        ...
        saveReferences: function($container, callback) {
            var references = [];
            $(".page-container .reference-item").each(function() {
        ...
        render: function(response) {
            ...
            $(".project-id,.project-id2,.project-id3").html(view.projectId);
            f.renderMultiLineText($("#project-purpose,#project-purpose2,#project-purpose3"), view.purpose);
            f.renderMultiLineText($("#project-range,#project-range2,#project-range3"), view.range);
            f.renderMultiLineText($("#project-foundation,#project-foundation2,#project-foundation3"), view.foundation);
            f.renderMultiLineText($("#report-overview .detail-content,#report-overview2 .detail-content"), view.overview);
            f.renderMultiLineText($("#report-overview-opinion .detail-content,#report-overview-opinion2 .detail-content"), view.overviewOpinion);
            $("#report-overview,#report-overview2").attr("itemId", view.id);
            $("#report-overview-opinion,#report-overview-opinion2").attr("itemId", view.id);
        ...
        renderDiscoveries: function(view) {
            $("#discovery-container,#discovery-container2").html($.tmpl("discoveryTemplate", view.levelViews));
        ...
        renderDiscoveriesCount: function(view, mainCategories) {
            ...
            $("#discovery-count-container,#discovery-count-container2").html(html.join(''));
