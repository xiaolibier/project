...
<body class="page-header-fixed">
    ...
    <div class="container-fluid">
        <div class="page-container">
            ...
            <ul class="nav nav-pills" role="tablist">
                ...
                <li role="presentation" class="active"><a href="javascript:void(0)">问题归类管理</a></li>
            ...
            <div id="list-page">
                ...
                <form class="navbar-form navbar-right" onkeydown="if(event.keyCode==13)return false;" >
                    <button id="add" class="btn btn-default">新增问题归类</button>
                </form>
            ...
            <div id="edit-page">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">问题归类ID</label>
                        <div class="col-sm-4">
                            <input id="problem-id" type="text" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">所属模块</label>
                        <div class="col-sm-4">
                            <select id="problem-moduleId" class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select id="problem-categoryId" class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea id="problem-name" class="form-control"></textarea>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script src="js/problem-manager.js" type="text/javascript"></script>
</body>
