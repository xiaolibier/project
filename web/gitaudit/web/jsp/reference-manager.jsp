    ...
    <div class="container-fluid">
        <div class="page-container">
            ...
            <ul class="nav nav-pills" role="tablist">
                ...
                <li role="presentation" class="active"><a href="javascript:void(0)">依据管理</a></li>
            ...
            <div id="list-page">
                <form class="navbar-form navbar-left" onkeydown="if(event.keyCode==13)return false;" >
                    ...
                    <div class="form-group margin-right-20">
                        ...
                        <select id="condition-category" class="form-control" style="width: 300px;"></select>
                    </div>
                    <div class="form-group margin-right-20">
                        <label class="control-label">问题归类</label>
                        <select id="condition-problem" class="form-control" style="width: 400px;"></select>
                    </div>
                    <div class="form-group margin-right-20">
            ...
            <div id="edit-page">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">依据ID</label>
                        <div class="col-sm-4">
                            <input id="reference-id" type="text" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">所属模块</label>
                        <div class="col-sm-4">
                            <select id="reference-moduleId" class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select id="reference-categoryId" class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">问题归类</label>
                        <div class="col-sm-4">
                            <select id="reference-problemId" class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">依据</label>
                        <div class="col-sm-4">
                            <textarea id="reference-name" class="form-control"></textarea>
                        </div>
                    </div>
                </form>
            </div>
