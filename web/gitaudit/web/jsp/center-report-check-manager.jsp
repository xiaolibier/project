    ...
    <div class="container-fluid">
        <div class="page-container">
            <ol class="breadcrumb">
                ...
                <li>单中心稽查报告评审</li>
                <c:if test="${mode == 'all'}">
                    <li class="active">单中心审核任务</li>
                </c:if>
                <c:if test="${mode == 'onlyMine'}">
                    <li class="active">我的单中心审核任务</li>
                </c:if>
            </ol>
            ...
            <div class="margin-top-10">
                <table tableId="CenterReportCheckManager" class="table table-striped table-bordered table-hover dataTable">
                    <thead>
                        <tr>
                            <th>项目编号</th>
                            <th>项目名称</th>
