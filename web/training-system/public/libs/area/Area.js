...
function changeComplexProvince(f, k, e, d) {
    ...
    if (k[f] != undefined) {
		...
		h[0] = new Option("选择市 ", 0);
	}
    removeOptions(g); 
	g[0] = new Option("选择县 ", 0);
...
function changeCity(c, a, t) {
    $("#" + a).html('<option value="0" >选择县</option>');
    $("#" + a).unbind("change");
    c = parseInt(c); 
    var _d = sub_arr[c];
    var str = "";     
    str += "<option value='0' >选择县</option>";
