!function (e) {
  ...
  !function (i, a) {
    ...
    !function (e, t) {
      ...
      n('moxie/core/utils/Basic', [
      ], function () {
        function e(e) {
          return void 0 === e ? 'undefined' : null === e ? 'null' : e.nodeType ? 'node' : {
        ...
        return {
          ...
          atob: function (e, i) {
            ...
            e += '';
            do {
              a = d.indexOf(e.charAt(f++)),
              s = d.indexOf(e.charAt(f++)),
              u = d.indexOf(e.charAt(f++)),
              l = d.indexOf(e.charAt(f++)),
              c = a << 18 | s << 12 | u << 6 | l,
              n = c >> 16 & 255,
              r = c >> 8 & 255,
              o = 255 & c,
              m[p++] = 64 == u ? String.fromCharCode(n)  : 64 == l ? String.fromCharCode(n, r)  : String.fromCharCode(n, r, o)
            } while (f < e.length);
            return h = m.join(''),
            i ? t(h)  : h
          },
          btoa: function (t, i) {
            ...
            do {
              ...
              u = c >> 6 & 63,
              l = 63 & c,
              m[p++] = d.charAt(a) + d.charAt(s) + d.charAt(u) + d.charAt(l)
            } while (f < t.length);
            h = m.join('');
            var g = t.length % 3;
        ...
        function t(e, t, i) {
          ...
          for (e = s(e), t = s(t), r = Math.max(e.length, t.length), n = 0; n < r; n++) if (e[n] != t[n]) {
            ...
            rgx: function () {
              for (var e, t, i, n, r, o, a, s = 0, u = arguments; s < u.length; s += 2) {
                ...
                for (t = i = 0; t < l.length; t++) if (o = l[t].exec(this.getUA())) {
                  for (n = 0; n < c.length; n++) a = o[++i],
                  r = c[n],
                  'object' == typeof r && r.length > 0 ? 2 == r.length ? 'function' == typeof r[1] ? e[r[0]] = r[1].call(this, a)  : e[r[0]] = r[1] : 3 == r.length ? 'function' != typeof r[1] || r[1].exec && r[1].test ? e[r[0]] = a ? a.replace(r[1], r[2])  : void 0 : e[r[0]] = a ? r[1].call(this, a, r[2])  : void 0 : 4 == r.length && (e[r[0]] = a ? r[3].call(this, a.replace(r[1], r[2]))  : void 0)  : e[r] = a || void 0;
                  break
                }
                if (o) break
              }
        ...
        n = function () {
          var t = {
            ...
            use_data_uri_of: function (e) {
              return t.use_data_uri && e < 33000 || t.use_data_uri_over32kb()
            },
        ...
        a && (o.debug = {
          ...
          if ('string' === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log) /* window.console.log(t) */;
            ...
            i || (i = document.createElement('pre'), i.id = 'moxie-console', document.body.appendChild(i)),
            - 1 !== e.inArray(e.typeOf(t), [
              'object',
              'array'
            ]) ? function (e) {
        ...
        return {
          ...
          getPos: function (t, i) {
            ...
            u = 0,
            l = document;
            if (t = t, i = i || l.body, t && t.getBoundingClientRect && 'IE' === e.browser && (!l.documentMode || l.documentMode < 8)) return o = n(t),
            a = n(i),
            {
              x: o.x - a.x,
              y: o.y - a.y
        ...
        return i.extend(n.prototype, {
          ...
          dispatchEvent: function (n) {
            ...
            if ('string' !== i.typeOf(n)) {
              ...
              n = l.type,
              void 0 !== l.total && void 0 !== l.loaded && (c.total = l.total, c.loaded = l.loaded),
              c.async = l.async || !1
            }
            if ( - 1 !== n.indexOf('::') ? function (e) {
              ...
              c.type = n,
              u.unshift(c),
              a && e.debug.events && e.log('Event \'%s\' fired on %u', c.type, o);
              var f = [
              ];
              i.each(s, function (e) {
                u[0].target = e.scope,
                c.async ? f.push(function (t) {
                  setTimeout(function () {
        ...
        function r(n, o, u, l, c) {
          ...
          a && e.debug.runtime && e.log('\tdefault mode: %s', h),
          d = function () {
            var e = {
            };
            return {
            ...
            if (t.each(n, function (n, r) {
              if (i.hasOwnProperty(r)) {
                ...
                if ('string' == typeof s && (s = [
                  ...
                  if (!(o = t.arrayIntersect(o, s))) return a && e.debug.runtime && e.log('\t\t%c: %v (conflicting mode requested: %s)', r, n, s),
                  o = !1
                } else o = s
              }
            ...
            connectRuntime: function (o) {
              function s(i) {
                ...
                return i.length ? (u = i.shift().toLowerCase(), (c = n.getConstructor(u)) ? (a && e.debug.runtime && (e.log('Trying runtime: %s', u), e.log(o)), r = new c(o), r.bind('Init', function () {
                  r.initialized = !0,
                  a && e.debug.runtime && e.log('Runtime \'%s\' initialized', r.type),
                  setTimeout(function () {
                    r.clients++,
                    l.ruid = r.uid,
                  ...
                  a && e.debug.runtime && e.log('Runtime \'%s\' failed to initialize', r.type),
                  r.destroy(),
                  s(i)
                }), r.bind('Exception', function (i, n) {
                  var r = n.name + '(#' + n.code + ')' + (n.message ? ', from: ' + n.message : '');
                  a && e.debug.runtime && e.log('Runtime \'%s\' has thrown an exception: %s', this.type, r),
              ...
              if ('string' === i.typeOf(o) ? u = o : 'string' === i.typeOf(o.ruid) && (u = o.ruid), u) {
                if (r = n.getRuntime(u)) return l.ruid = u,
                r.clients++,
                r;
        ...
        'moxie/runtime/Runtime',
        'moxie/runtime/RuntimeClient'
      ], function (e, t, i, n, r, o, s, u, l) {
        function c(o) {
          a && t.log('Instantiating FileInput...');
          var c,
          f,
          p;
          if ( - 1 !== e.inArray(e.typeOf(o), [
            'string',
            'node'
          ]) && (o = {
            browse_button: o
            ...
            init: function () {
              ...
              t.bind('RuntimeInit', function (i, r) {
                ...
                t.bind('Refresh', function () {
                  ...
                  s,
                  u;
                  a = n.get(o.browse_button),
                  s = n.get(r.shimid),
                  a && (t = n.getPos(a, n.get(o.container)), i = n.getSize(a), u = parseInt(n.getStyle(a, 'z-index'), 10) || 0, s && e.extend(s.style, {
                    top: t.y + 'px',
                    left: t.x + 'px',
                    width: i.w + 'px',
                    height: i.h + 'px',
        ...
        function a() {
          function n(e, n) {
            ...
            } else this.connectRuntime(n.ruid),
        ...
        var t = function (i, n) {
          ...
          if (r = !d && !u.scheme, (d || r) && (u.scheme = n.scheme), r) {
            ...
            u.port = n.port;
            var f = '';
            /^[^\/]/.test(u.path) && (f = n.path, f = /\/[^\/]*\.[^\/]*$/.test(f) ? f.replace(/\/[^\/]+$/, '/')  : f.replace(/\/?$/, '/')),
            u.path = f + (u.path || '')
        }
      ...
      function p() {
        ...
        function u(t) {
          ...
          function r(r) {
            b.bind('LoadStart', function (e) {
              i('readyState', p.LOADING),
              s.dispatchEvent('readystatechange'),
              s.dispatchEvent(e),
              k && s.upload.dispatchEvent(e)
            }),
            b.bind('Progress', function (e) {
              i('readyState') !== p.LOADING && (i('readyState', p.LOADING), s.dispatchEvent('readystatechange')),
              s.dispatchEvent(e)
            }),
            ...
            b.bind('Load', function (t) {
              ...
              ~e.inArray(i('responseType'), [
                'text',
                ''
              ]) ? i('responseText', i('response'))  : 'document' === i('responseType') && i('responseXML', i('response')),
              P = r.exec.call(b, 'XMLHttpRequest', 'getAllResponseHeaders'),
              s.dispatchEvent('readystatechange'),
              i('status') > 0 ? (k && s.upload.dispatchEvent(t), s.dispatchEvent(t))  : (F = !0, s.dispatchEvent('error')),
              n()
            }),
        ...
        e.extend(this, T, {
          ...
          setRequestHeader: function (r, o) {
            ...
            !~e.inArray(r, a) && !/^(proxy\-|sec\-)/.test(r) && (I[r] ? I[r] += ', ' + o : I[r] = o, !0)
          },
          ...
          send: function (i, r) {
            if (z = 'string' === e.typeOf(r) ? {
             ...
             : r || {
            }, this.readyState !== p.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
            if (i instanceof s) z.ruid = i.ruid,
            ...
            k = !C && this.upload.hasEventListener(),
            F = !1,
            L = !i,
            C || (N = !0),
            u.call(this, i)
          ...
          abort: function () {
            if (F = !0, C = !1, ~e.inArray(i('readyState'), [
              p.UNSENT,
              p.OPENED,
              p.DONE
            ])) i('readyState', p.UNSENT);
             else {
          ...
          destroy: function () {
            b && ('function' === e.typeOf(b.destroy) && b.destroy(), b = null),
            this.unbindAll(),
      ...
      function r() {
        ...
        function o(t, i) {
          ...
          n.bind('TransportingProgress', function (t) {
            (d = t.loaded) < c && - 1 === e.inArray(n.state, [
              r.IDLE,
              r.DONE
            ]) && a.call(n)
          }, 999),
      ...
      'moxie/file/File',
      'moxie/core/utils/Encode'
    ], function (e, t, i, n, r, o, a, s, u, l, c, d, f) {
      function p() {
        function n(e) {
          try {
        ...
        e.extend(this, {
          ...
          resize: function (t) {
            ...
            try {
              ...
              if (n = o.meta && o.meta.tiff && o.meta.tiff.Orientation || 1, - 1 !== e.inArray(n, [
                5,
                6,
                7,
                8
          ...
          embed: function (n, r) {
            function o(t, r) {
              ...
              if (u.can('use_data_uri_of', d.length)) n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" />',
              o.destroy(),
              l.trigger('embedded');
               else {
                var p = new s;
                p.bind('TransportingComplete', function () {
                  a = l.connectRuntime(this.result.ruid),
                  ...
                  a.exec.call(l, 'ImageView', 'display', this.result.uid, width, height),
                  o.destroy()
                }),
      ...
      return p.MAX_RESIZE_WIDTH = 8192,
      p.MAX_RESIZE_HEIGHT = 8192,
      p.prototype = l.instance,
      p
    }), n('moxie/runtime/html5/Runtime', [
      'moxie/core/utils/Basic',
      'moxie/core/Exceptions',
      'moxie/runtime/Runtime',
      'moxie/core/utils/Env'
      ...
      function o(t) {
        ...
        c = e.extend({
          ...
          summon_file_dialog: function () {
            return o.can('select_file') && ('Firefox' === n.browser && n.verComp(n.version, 4, '>=') || 'Opera' === n.browser && n.verComp(n.version, 12, '>=') || 'IE' === n.browser && n.verComp(n.version, 10, '>=') || !!~e.inArray(n.browser, [
              'Chrome',
              'Safari',
              'Edge'
            ]))
      ...
      o = function (o, a, s, u) {
        ...
        c;
        a = a.toLowerCase(),
        o.addEventListener ? (l = s, o.addEventListener(a, l, !1))  : o.attachEvent && (l = function () {
          var e = window.event;
          e.target || (e.target = e.srcElement),
          e.preventDefault = t,
          e.stopPropagation = i,
          s(e)
        }, o.attachEvent('on' + a, l)),
        o[r] || (o[r] = e.guid()),
      ...
      function s() {
        ...
        i.extend(this, {
          init: function (u) {
            ...
            f = n.get(e.browse_button),
            s = n.getStyle(f, 'z-index') || 'auto',
            g.can('summon_file_dialog') && ('static' === n.getStyle(f, 'position') && (f.style.position = 'relative'), r.addEvent(f, 'click', function (e) {
              var t = n.get(g.uid);
              t && !t.disabled && t.click(),
              e.preventDefault()
            }, m.uid), m.bind('Refresh', function () {
              p = parseInt(s, 10) || 1,
              n.get(e.browse_button).style.zIndex = p,
              this.getRuntime().getShimContainer().style.zIndex = p - 1
            })),
            h = g.can('summon_file_dialog') ? f : c,
      ...
      function a() {
        ...
        i.extend(this, {
          ...
          destroy: function () {
            r.removeAllEvents(p && n.get(p.container), this.uid),
            h = m = g = p = null
          }
        })
      }
      return e.FileDrop = a
    }), n('moxie/runtime/html5/file/FileReader', [
      'moxie/runtime/html5/Runtime',
      'moxie/core/utils/Encode',
      'moxie/core/utils/Basic'
    ], function (e, t, i) {
    ...
    }), n('moxie/runtime/html5/xhr/XMLHttpRequest', [
      'moxie/runtime/html5/Runtime',
      'moxie/core/utils/Basic',
      'moxie/core/utils/Mime',
      'moxie/core/utils/Url',
      ...
      function l() {
        ...
        function c(e) {
          var t = e.responseXML,
          i = e.responseText;
          return 'IE' === u.browser && i && t && !t.documentElement && /[^\/]+\/[^\+]+\+xml/.test(e.getResponseHeader('Content-Type')) && (t = new window.ActiveXObject('Microsoft.XMLDOM'), t.async = !1, t.validateOnParse = !1, t.loadXML(i)),
        ...
        t.extend(this, {
          send: function (i, r) {
            ...
            m = !1;
            if (p = i.url.replace(/^.+?\/([\w\-\.]+)$/, '$1').toLowerCase(), f = l(), f.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (m = !0),
            r = r.getSource();
            ...
            f.upload ? (i.withCredentials && (f.withCredentials = !0), f.addEventListener('load', function (e) {
              ...
              switch (f.readyState) {
                ...
                case 3:
                  ...
                  t;
                  try {
                    n.hasSameOrigin(i.url) && (e = f.getResponseHeader('Content-Length') || 0),
                ...
                case 4:
                  ...
                  0 === f.status ? s.trigger('error')  : s.trigger('load')
              }
            },
            t.isEmptyObj(i.headers) || t.each(i.headers, function (e, t) {
              f.setRequestHeader(t, e)
            }),
            '' !== i.responseType && 'responseType' in f && ('json' !== i.responseType || u.can('return_response_type', 'json') ? f.responseType = i.responseType : f.responseType = 'text'),
            m ? f.sendAsBinary ? f.sendAsBinary(r)  : function () {
    ...
    n('moxie/runtime/html5/utils/BinaryReader', [
      'moxie/core/utils/Basic'
    ], function (e) {
      function t(e) {
      ...
      return e.extend(t.prototype, {
        ...
        asArray: function (e, t, i) {
          for (var n = [
          ], r = 0; r < i; r++) n[r] = this[e](t + r);
          return n
        }
      }),
      t
    }),
    n('moxie/runtime/html5/image/JPEGHeaders', [
      ...
      return function i(n) {
        ...
        u = 0;
        if (r = new e(n), 65496 !== r.SHORT(0)) throw r.clear(),
        new t.ImageError(t.ImageError.WRONG_FORMAT);
        for (o = 2; o <= r.length(); ) if ((a = r.SHORT(o)) >= 65488 && a <= 65495) o += 2;
         else {
          if (65498 === a || 65497 === a) break;
          u = r.SHORT(o + 2) + 2,
          a >= 65505 && a <= 65519 && s.push({
            hex: a,
            name: 'APP' + (15 & a),
            start: o,
            length: u,
        ...
        return r.clear(),
        {
          ...
          restore: function (t) {
            ...
            n,
            r;
            for (r = new e(t), o = 65504 == r.SHORT(2) ? 4 + r.SHORT(4)  : 2, n = 0, i = s.length; n < i; n++) r.SEGMENT(o, 0, s[n].segment),
            o += s[n].length;
            return t = r.SEGMENT(),
            r.clear(),
            t
          ...
          get: function (e) {
            for (var t = [
            ], i = 0, n = s.length; i < n; i++) s[i].name === e.toUpperCase() && t.push(s[i].segment);
            return t
          },
          set: function (e, t) {
            var i,
    ...
    n('moxie/runtime/html5/image/ExifParser', [
      'moxie/core/utils/Basic',
      'moxie/runtime/html5/utils/BinaryReader',
      'moxie/core/Exceptions'
    ], function (e, i, n) {
      function r(o) {
        function a(i, r) {
          ...
          for (o = m.SHORT(i), a = 0; a < o; a++) if (g = [
          ], p = i + 2 + 12 * a, (s = r[m.SHORT(p)]) !== t) {
        ...
        d.IFD0 = d.tiffHeader + this.LONG(f += 2),
        p = a.call(this, d.IFD0, l.tiff),
        'ExifIFDPointer' in p && (d.exifIFD = d.tiffHeader + p.ExifIFDPointer, delete p.ExifIFDPointer),
        'GPSInfoIFDPointer' in p && (d.gpsIFD = d.tiffHeader + p.GPSInfoIFDPointer, delete p.GPSInfoIFDPointer),
        e.isEmptyObj(p) && (p = null);
    ...
    n('moxie/runtime/html5/image/JPEG', [
      'moxie/core/utils/Basic',
      'moxie/core/Exceptions',
    ...
    n('moxie/runtime/html5/image/PNG', [
      'moxie/core/Exceptions',
      'moxie/core/utils/Basic',
      'moxie/runtime/html5/utils/BinaryReader'
    ], function (e, t, i) {
    ...
    n('moxie/runtime/html5/image/ImageInfo', [
      'moxie/core/utils/Basic',
      'moxie/core/Exceptions',
    ...
    n('moxie/runtime/html5/image/ResizerCanvas', [
    ], function () {
      function e(i, n) {
        var r = i.width,
        o = Math.floor(r * n),
        a = !1;
        (n < 0.5 || n > 2) && (n = n < 0.5 ? 0.5 : 2, a = !0);
        var s = t(i, n);
    ...
    n('moxie/runtime/html5/image/Image', [
      'moxie/runtime/html5/Runtime',
      'moxie/core/utils/Basic',
      'moxie/core/Exceptions',
      'moxie/core/utils/Encode',
      ...
      function c() {
        ...
        function h(e, i) {
          ...
          switch (t.inArray(i, [
              ...
              7,
              8
            ]) > - 1 ? (r.width = s, r.height = a)  : (r.width = a, r.height = s), i) {
            case 2:
              o.translate(a, 0),
              o.scale( - 1, 1);
              break;
        ...
        t.extend(this, {
          loadFromBlob: function (e) {
            ...
            if (y = e, e.isDetached()) return _ = e.getSource(),
            void f.call(this, _);
          ...
          getInfo: function () {
            var t,
            i = this.getRuntime();
            return !v && _ && i.can('access_image_binary') && (v = new a(_)),
            t = {
              width: e().width || 0,
              height: e().height || 0,
          ...
          getAsBinaryString: function (e, t) {
            if (!E) return _ || (_ = c(w.getAsDataURL(e, t))),
            _;
            if ('image/jpeg' !== e) _ = c(w.getAsDataURL(e, t));
              ...
              _ = c(i),
              v && (_ = v.stripHeaders(_), b && (v.meta && v.meta.exif && v.setExif({
      ...
      function c(l) {
        ...
        o.call(this, l, d, {
          ...
          return_response_headers: !1,
          return_response_type: function (t) {
            return !('json' !== t || !window.JSON) || (!e.arrayDiff(t, [
              '',
              'text',
              'document'
            ]) || 'browser' === p.mode)
          ...
          return_status_code: function (t) {
            return 'browser' === p.mode || !e.arrayDiff(t, [
              200,
              404
            ])
          },
        ...
        s() < 11.3 && (a && t.debug.runtime && t.log('\tFlash didn\'t meet minimal version requirement (11.3).'), this.mode = !1),
        e.extend(this, {
          getShim: function () {
          ...
          init: function () {
            ...
            'IE' === t.browser ? (r = document.createElement('div'), o.appendChild(r), r.outerHTML = i, r = o = null)  : o.innerHTML = i,
      ...
      f
    }), n('moxie/runtime/flash/file/Blob', [
      ...
      return e.Blob = i
    }), n('moxie/runtime/flash/file/FileInput', [
      'moxie/runtime/flash/Runtime',
      'moxie/file/File',
      'moxie/core/utils/Basic'
    ], function (e, t, i) {
    ...
    }), n('moxie/runtime/flash/file/FileReader', [
      'moxie/runtime/flash/Runtime',
      'moxie/core/utils/Encode'
    ], function (e, t) {
      function i(e, i) {
      ...
      return e.FileReader = n
    }), n('moxie/runtime/flash/file/FileReaderSync', [
      'moxie/runtime/flash/Runtime',
      'moxie/core/utils/Encode'
    ], function (e, t) {
      function i(e, i) {
    ...
    }), n('moxie/runtime/flash/runtime/Transporter', [
      'moxie/runtime/flash/Runtime',
      'moxie/file/Blob'
    ], function (e, t) {
      var i = {
      ...
      return e.XMLHttpRequest = l
    }), n('moxie/runtime/flash/image/Image', [
      'moxie/runtime/flash/Runtime',
      'moxie/core/utils/Basic',
      'moxie/runtime/Transporter',
      'moxie/file/Blob',
      ...
      return e.Image = o
    }), n('moxie/runtime/silverlight/Runtime', [
      'moxie/core/utils/Basic',
      'moxie/core/utils/Env',
      'moxie/core/utils/Dom',
      'moxie/core/Exceptions',
      ...
      function u(u) {
        ...
        o.call(this, u, l, {
          ...
          return_status_code: function (t) {
            return 'client' === f.mode || !e.arrayDiff(t, [
              200,
              404
            ])
          },
        ...
        s('2.0.31005.0') && 'Opera' !== t.browser || (a && t.debug.runtime && t.log('\tSilverlight is not installed or minimal version (2.0.31005.0) requirement not met (not likely).'), this.mode = !1),
        e.extend(this, {
          getShim: function () {
      ...
      c
    }), n('moxie/runtime/silverlight/file/Blob', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/core/utils/Basic',
      'moxie/runtime/flash/file/Blob'
    ], function (e, t, i) {
      return e.Blob = t.extend({
      }, i)
    }), n('moxie/runtime/silverlight/file/FileInput', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/file/File',
      'moxie/core/utils/Basic'
    ], function (e, t, i) {
      ...
      return e.FileDrop = n
    }), n('moxie/runtime/silverlight/file/FileReader', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/core/utils/Basic',
      'moxie/runtime/flash/file/FileReader'
    ], function (e, t, i) {
      return e.FileReader = t.extend({
      }, i)
    }), n('moxie/runtime/silverlight/file/FileReaderSync', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/core/utils/Basic',
      'moxie/runtime/flash/file/FileReaderSync'
    ], function (e, t, i) {
      return e.FileReaderSync = t.extend({
      }, i)
      ...
      return e.Transporter = t.extend({
      }, i)
    }), n('moxie/runtime/silverlight/xhr/XMLHttpRequest', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/core/utils/Basic',
      ...
      return e.XMLHttpRequest = t.extend({
      }, i)
    }), n('moxie/runtime/silverlight/image/Image', [
      'moxie/runtime/silverlight/Runtime',
      'moxie/core/utils/Basic',
      'moxie/file/Blob',
      'moxie/runtime/flash/image/Image'
    ], function (e, t, i, n) {
      return e.Image = t.extend({
      }, n, {
        getInfo: function () {
          var e = this.getRuntime(),
          n = [
          ...
          return o.meta && (t.each(n, function (e) {
            ...
            a,
            s = o.meta[e];
            if (s && s.keys) for (r.meta[e] = {
            }, i = 0, n = s.keys.length; i < n; i++) t = s.keys[i],
            (a = s[t]) && (/^(\d|[1-9]\d+)$/.test(a) ? a = parseInt(a, 10)  : /^\d*\.\d+$/.test(a) && (a = parseFloat(a)), r.meta[e][t] = a)
      ...
      function o(t) {
        ...
        i.call(this, t, a, {
          ...
          return_response_headers: !1,
          return_response_type: function (t) {
            return !('json' !== t || !window.JSON) || !!~e.inArray(t, [
              'text',
              'document',
              ''
            ])
      ...
      return i.addConstructor(a, o),
      s
    }), n('moxie/runtime/html4/file/FileInput', [
      ...
      function s() {
        function e() {
          ...
          s && (d = n.get(s + '_form')) && i.extend(d.style, {
            top: '100%'
          }),
          f = document.createElement('form'),
          f.setAttribute('id', h + '_form'),
          ...
          p.onchange = function () {
            ...
            if (this.value) {
              ...
              p.setAttribute('id', i.uid),
              f.setAttribute('id', i.uid + '_form'),
              m.trigger('change'),
              p = f = null
            }
          },
        ...
        i.extend(this, {
          init: function (t) {
            ...
            s = a.getRuntime();
            u = t,
            c = t.accept.mimes || o.extList2mimes(t.accept, s.can('filter_by_extension')),
            ...
            function () {
              ...
              s.can('summon_file_dialog') && ('static' === n.getStyle(e, 'position') && (e.style.position = 'relative'), a.bind('Refresh', function () {
                o = parseInt(l, 10) || 1,
                n.get(u.browse_button).style.zIndex = o,
                this.getRuntime().getShimContainer().style.zIndex = o - 1
              })),
              c = s.can('summon_file_dialog') ? e : i,
          ...
          setOption: function (e, t) {
            ...
            (i = n.get(s)) && i.setAttribute('accept', c.join(','))
          },
          disable: function (e) {
            var t;
          ...
          destroy: function () {
            ...
            a && (r.removeAllEvents(a, this.uid), a.style.zIndex = l),
      ...
      return e.FileInput = s
    }), n('moxie/runtime/html4/file/FileReader', [
      'moxie/runtime/html4/Runtime',
      'moxie/runtime/html5/file/FileReader'
    ], function (e, t) {
      return e.FileReader = t
    }), n('moxie/runtime/html4/xhr/XMLHttpRequest', [
      'moxie/runtime/html4/Runtime',
      'moxie/core/utils/Basic',
      'moxie/core/utils/Dom',
      'moxie/core/utils/Url',
      ...
      function u() {
        ...
        t.extend(this, {
          send: function (d, f) {
            ...
            h.setAttribute('target', p + '_iframe'),
            f instanceof s && f.each(function (e, i) {
            ...
            function () {
              ...
              r.innerHTML = '<iframe id="' + p + '_iframe" name="' + p + '_iframe" src="javascript:&quot;&quot;" style="display:none"></iframe>',
              c = r.firstChild,
              i.appendChild(c),
              o.addEvent(c, 'load', function () {
                ...
                try {
                  ...
                  /^4(0[0-9]|1[0-7]|2[2346])\s/.test(i.title) ? u = i.title.replace(/^(\d+).*$/, '$1')  : (u = 200, l = t.trim(i.body.innerHTML), v.trigger({
                    type: 'progress',
                    loaded: l.length,
                    total: l.length
                  }), g && v.trigger({
    ...
    }), n('moxie/runtime/html4/image/Image', [
      'moxie/runtime/html4/Runtime',
  ...
  !function (e, t, i) {
    ...
    u = {
      ...
      predictRuntime: function (e, t) {
        ...
        n = s.thatCan(i.getOption().required_features, t || e.runtimes),
        i.destroy(),
        n
      },
    ...
    u.Uploader = function (e) {
      ...
      function c() {
        ...
        n,
        r = 0;
        for (A.reset(), e = 0; e < D.length; e++) t = D[e],
        t.size !== i ? (A.size += t.origSize, n = t.loaded * t.origSize / t.size, (!t.completeTimestamp || t.completeTimestamp > T) && (r += n), A.loaded += n)  : A.size = i,
        t.status == u.DONE ? A.uploaded++ : t.status == u.FAILED ? A.failed++ : A.queued++;
        A.size === i ? A.percent = D.length > 0 ? Math.ceil(A.uploaded / D.length * 100)  : 0 : (A.bytesPerSec = Math.ceil(r / (( + new Date - T || 1) / 1000)), A.percent = A.size > 0 ? Math.ceil(A.loaded / A.size * 100)  : 0)
      }
      function d() {
        var e = N[0] || k[0];
      ...
      function h(e, i) {
        ...
        e.browse_button && u.each(e.browse_button, function (i) {
          o.push(function (o) {
            var l = new t.file.FileInput(u.extend({
            }, a, {
        ...
        e.drop_element && u.each(e.drop_element, function (e) {
          o.push(function (i) {
            var o = new t.file.FileDrop(u.extend({
            }, a, {
              drop_zone: e
            }));
            o.onready = function () {
      ...
      function m(e, n, r) {
        ...
        try {
          o.onload = function () {
            if (n.width > this.width && n.height > this.height && n.quality === i && n.preserve_headers && !n.crop) return this.destroy(),
            r(e);
      ...
      function g(e, i, r) {
        function o(e, i, n) {
          ...
          switch (e) {
            ...
            case 'filters':
              ...
              n ? u.extend(S.filters, i)  : S.filters = i,
              i.mime_types && ('string' === u.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function (e) {
                var t = [
                ];
        ...
        r ? (S.required_features = n(u.extend({
        }, S)), C = n(u.extend({
        }, S, {
          required_features: !0
      ...
      function x(e, i) {
        function n() {
          d-- > 0 ? r(o, 1000)  : (i.loaded = h, e.trigger('Error', {
            code: u.HTTP_ERROR,
        ...
        function a(a, c, f) {
          ...
          I.onload = function () {
            ...
            f < s.size ? (c.destroy(), h += f, i.loaded = Math.min(h, s.size), e.trigger('ChunkUploaded', i, {
              offset: i.loaded,
              total: s.size,
              response: I.responseText,
              status: I.status,
            ...
            c = m = null,
            !h || h >= s.size ? (i.size != i.origSize && (s.destroy(), s = null), e.trigger('UploadProgress', i), i.status = u.DONE, i.completeTimestamp = + new Date, e.trigger('FileUploaded', i, {
              response: I.responseText,
              status: I.status,
              responseHeaders: I.getAllResponseHeaders()
            }))  : r(o, 1)
        ...
        s = i.getSource(),
        !u.isEmptyObj(e.settings.resize) && f(s, 'send_binary_string') && - 1 !== u.inArray(s.type, [
          'image/jpeg',
          'image/png'
        ]) ? m.call(this, s, e.settings.resize, function (e) {
          s = e,
          i.size = e.size,
          o()
        })  : o()
      ...
      function y(e) {
        if (e.state == u.STARTED) T = + new Date;
         else if (e.state == u.STOPPED) for (var t = e.files.length - 1; t >= 0; t--) e.files[t].status == u.UPLOADING && (e.files[t].status = u.QUEUED, c())
      }
      function w() {
        I && I.abort()
      }
      ...
      u.extend(this, {
        ...
        addFile: function (e, i) {
          ...
          function a(e) {
            ...
            if (e instanceof t.file.File) {
              ...
              n(e, function (i) {
                i || (D.push(e), f.push(e), l.trigger('FileFiltered', e)),
                r(t, 1)
              })
            }))  : - 1 !== u.inArray(o, [
              'file',
              'blob'
            ]) ? a(new t.file.File(null, e))  : 'node' === o && 'filelist' === u.typeOf(e.files) ? u.each(e.files, a)  : 'array' === o && (i = null, u.each(e, a))
          }
          var s,
          l = this,
          c = [
        ...
        splice: function (e, t) {
          ...
          return this.state == u.STARTED && (u.each(n, function (e) {
            if (e.status === u.UPLOADING) return r = !0,
            !1
          }), r && this.stop()),
...
!function (global) {
  ...
  function QiniuJsSDK() {
    function log(e, t) {
      ...
      //that.detectIEVersion() ? console.log(n)  : (t.unshift(i), console.log.apply(console, t)),
    ...
    function StatisticsLogger() {
      function e() {
        for (var e = [
        ], i = 0; i < n.length; i++) n[i].status !== r.finished && e.push(n[i]),
    ...
    this.detectIEVersion = function () {
      for (var e = 4, t = document.createElement('div'), i = t.getElementsByTagName('i'); t.innerHTML = '<!--[if gt IE ' + e + ']><i></i><![endif]-->', i[0]; ) e++;
      return e > 4 && e
    };
    var logger = {
      MUTE: 0,
    ...
    this.base64_decode = function (e) {
      ...
      do {
        ...
        i = u >> 8 & 255,
        n = 255 & u,
        f[d++] = 64 === a ? String.fromCharCode(t)  : 64 === s ? String.fromCharCode(t, i)  : String.fromCharCode(t, i, n)
      } while (c < e.length);
      return f.join('')
    },
    this.base64_encode = function (e) {
      ...
      do {
        ...
        a = u >> 6 & 63,
        s = 63 & u,
        p[d++] = l.charAt(r) + l.charAt(o) + l.charAt(a) + l.charAt(s)
      } while (c < e.length);
      ...
      switch (typeof e) {
        ...
        case 'object':
          if (e instanceof Array) {
            for (var t = [
            ], i = e.length, n = 0; n < i; n++) t.push(that.stringifyJSON(e[n]));
            return '[' + t.join(',') + ']'
          }
    ...
    this.uploader = function (e) {
      var t = function (e) {
        ...
        return n.ak = i,
        n.scope.indexOf(':') >= 0 ? (n.bucket = n.scope.split(':') [0], n.key = n.scope.split(':') [1])  : n.bucket = n.scope,
        n
      },
      i = function (i) {
        var n = t(i),
        ...
        var o,
        a = that.detectIEVersion();
        a && a <= 9 ? (o = new moxie.xhr.XMLHttpRequest, moxie.core.utils.Env.swf_url = e.flash_swf_url)  : o = that.createAjax(),
        o.open('GET', r, !1);
        var s = function () {
        ...
        a && a <= 9 ? o.bind('readystatechange', s)  : o.onreadystatechange = s,
        o.send()
      },
      n = function (t) {
      ...
      r = function (t) {
        if (e.uptoken) that.token = e.uptoken;
          ...
          if (n.open('GET', that.uptoken_url, !1), n.send(), 200 === n.status) {
            ...
            var s = function (e) {
              return Math.ceil(e.getTime() / 1000)
            },
      ...
      h && h <= 9 && (p.multipart_params.accept = 'text/plain; charset=utf-8', logger.debug('add accept text/plain in multipart params')),
      plupload.extend(u, e, p),
      ...
      m.bind('BeforeUpload', function (t, i) {
        ...
        var a = function (t, i, n) {
          ...
          a && a <= 9 && (r.accept = 'text/plain; charset=utf-8', logger.debug('add accept text/plain in multipart params')),
        ...
        if (u = u || t.settings && t.settings.chunk_size, logger.debug('uploader.runtime: ', m.runtime), logger.debug('chunk_size: ', u), 'html5' !== m.runtime && 'flash' !== m.runtime || !u) logger.debug('directUpload because uploader.runtime !== \'html5\' || uploader.runtime !== \'flash\' || !chunk_size'),
        a(t, i, that.key_handler);
         else if (i.size < u || s()) logger.debug('directUpload because file.size < chunk_size || is_android_weixin_or_qq()'),
        a(t, i, that.key_handler);
         else {
          ...
          if (l) {
            ...
            h = l.time || 0;
            p - h < 86400000 && 100 !== l.percent && i.size === l.total ? (i.percent = l.percent, i.loaded = l.offset, d = l.ctx, f.isResumeUpload = !0, f.resumeFilesize = l.offset, l.offset + c > i.size && (c = i.size - l.offset))  : localStorage.removeItem(i.name)
          }
          f.startTime = (new Date).getTime();
          var g = {
          },
          v = that.detectIEVersion();
          v && v <= 9 && (g.accept = 'text/plain; charset=utf-8', logger.debug('add accept text/plain in multipart params')),
          t.setOption({
      ...
      m.bind('UploadProgress', function (e, t) {
        ...
        n = t.loaded || 0;
        f.isResumeUpload && (n = t.loaded - f.resumeFilesize),
        t.speed = (n / i * 1000).toFixed(0) || 0
      }),
      ...
      m.bind('ChunkUploaded', function (e, t, i) {
        ...
        a = a || e.settings && e.settings.chunk_size,
        o < a && (e.setOption({
      ...
      return m.bind('Error', function (t) {
        return function (i, n) {
          ...
          if (i.refresh(), !e.disable_statistics_report) {
            ...
            statisticsLogger.log(0 === h ? ExtraErrors.NetworkError : h, p, a(i.settings.url), void 0, s(i.settings.url), (r.getTime() - g) / 1000, parseInt(g / 1000), n.file.size * (n.file.percent / 100), 'jssdk-' + i.runtime, u.size)
        }
      }
    }(l)),
    ...
    m.bind('FileUploaded', function (t) {
      return function (i, n, r) {
          ...
          if (logger.debug('FileUploaded last step:', r), e.downtoken_url) {
            ...
            o.onreadystatechange = function () {
              if (4 === o.readyState) if (200 === o.status) {
                ...
                plupload.extend(a, that.parseJSON(r.response), e),
                r.response = that.stringifyJSON(a),
                t && t(i, n, r)
        ...
        if (d = d || c.ctx, logger.debug('ctx: ', d), d) {
          ...
          e.save_key || (f = o(i, n, that.key_handler), f = f ? '/key/' + that.URLSafeBase64Encode(f)  : '');
          ...
          var _,
          y = qiniuUploadUrl + '/mkfile/' + n.size + f + p + v,
          w = that.detectIEVersion();
          w && w <= 9 ? (_ = new moxie.xhr.XMLHttpRequest, moxie.core.utils.Env.swf_url = e.flash_swf_url)  : _ = that.createAjax(),
          _.open('POST', y, !0),
        ...
        if (!e.disable_statistics_report) {
          ...
          statisticsLogger.log(r.status, b, a(i.settings.url), void 0, s(i.settings.url), (u.getTime() - R) / 1000, parseInt(R / 1000), n.size, 'jssdk-' + i.runtime, n.size)
        }
      }
    }(c)),
    ...
    m.bind('FilesRemoved', function (t, i) {
      var n = new Date;
      if (!e.disable_statistics_report) for (var r = 0; r < i.length; r++) statisticsLogger.log(ExtraErrors.Cancelled, void 0, a(t.settings.url), void 0, s(t.settings.url), (n.getTime() - i[r]._start_at.getTime()) / 1000, i[r]._start_at.getTime() / 1000, i[r].size * i[r].percent / 100, 'jssdk-' + t.runtime, i[r].size)
    }),
    ...
    if (1 === i) {
      ...
      u = e.fill ? e.fill : '';
      if (!o) return !1;
      n += o ? '/text/' + this.URLSafeBase64Encode(o)  : '',
      n += a ? '/font/' + this.URLSafeBase64Encode(a)  : '',
      n += s ? '/fontsize/' + s : '',
      n += u ? '/fill/' + this.URLSafeBase64Encode(u)  : ''
    }
    var l = e.dissolve || '',
    c = e.gravity || '',
    d = e.dx || '',
    f = e.dy || '';
    return n += l ? '/dissolve/' + l : '',
    n += c ? '/gravity/' + c : '',
    n += d ? '/dx/' + d : '',
    n += f ? '/dy/' + f : '',
    t && (n = this.getUrl(t) + '?' + n),
    ...
    if (!e) return !1;
    var t,
    i = this.getUrl(e) + '?imageInfo',
    n = this.createAjax(),
    r = this;
    return n.open('GET', i, !1),
...
}); var Qiniu = new QiniuJsSDK; global.Qiniu = Qiniu, global.QiniuJsSDK = QiniuJsSDK, void 0 !== module && module.exports ? module.exports = QiniuJsSDK : (__WEBPACK_AMD_DEFINE_ARRAY__ = [
