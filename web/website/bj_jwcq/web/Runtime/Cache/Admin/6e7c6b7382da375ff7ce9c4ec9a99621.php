...
$(document).ready(function(){
	...
	</script></head><body><div class="con-ico"><div class="con-fl" style="height:30px;">当前位置：我的站点 ><a href="__APP__/Admin/Product/caselist?ffaID=<?php echo ($ffaids); ?>&faID=<?php echo ($ffaids); ?>&Language=<?php echo ($language); ?>"><?php echo ($nicknames); ?></a> ><a href="__APP__/Admin/Product/caselist?ffaID=<?php echo ($ffaids); ?>&faID=<?php echo ($main_father); ?>&Language=<?php echo ($language); ?>"><?php echo ($main_names); ?></a><a href="__APP__/Admin/Product/caseNewsList?ffaID=<?php echo ($ffaids); ?>&faID=<?php echo ($col_menuid); ?>&Language=<?php echo ($language); ?>"><?php echo ($nickname); ?></a> > 信息编辑</div></div><table width="855" border="0" cellpadding="0" cellspacing="0" style="WIDTH: 850px; HEIGHT: 380px"><tr><td width="855" colspan="2" align="left" valign="top" style="HEIGHT: 381px"><form name="Gforms" method="post" action="__APP__/Admin/Product/casecolcreat_add?id=<?php echo ($id); ?>&Language=<?php echo ($language); ?>" enctype="multipart/form-data"><table width="96%" border="0" cellpadding="0" cellspacing="0"  class="content-table"><tr class="content-table"><th align="right" class="tdblodthnone"> 属性项 </th><th class="tdblodthnone"> 属性值        </tr><tr><td align="right" bgcolor="#F4F4F4" height="20">信息归属：</td><td bgcolor="#F4F4F4"><label><?php echo ($nickname); ?></label></td></tr><tr><td width="149" align="right" bgcolor="#F4F4F4">信息标题：</td><td width="619" bgcolor="#F4F4F4"><label><input name="ColTitle" type="text" class="input_3" id="ColTitle" size="80" value="<?php echo ($col_newsinfo["Col_Title"]); ?>"></label></td></tr><tr style="" bgcolor="#F4F4F4"><td height="20" align="right">链接地址：</td><td bgcolor="#F4F4F4"><input name="ColEditor" type="text" class="input_3" id="ColEditor" size="50" value="<?php echo ($col_newsinfo["Col_Editor"]); ?>" /></td></tr><tr style=""><td height="20" align="right" bgcolor="#F4F4F4">信息图片：</td><td bgcolor="#F4F4F4"><label><input name="image" id="image" type="file" class="file huge" />大小：1921*330
			</label><?php if($Col_Pic != '' ): ?><a href="#" class="tip">查看图片</a><?php else: endif; ?></td><div id="sunflowamedia0" class="tooltip"><p><img src="__SYSWEB__/Uploads/<?php echo ($Col_Pic); ?>" /></p></div></tr><tr style="display:none"><td height="20" align="right" bgcolor="#F4F4F4">信息文件：</td><td bgcolor="#F4F4F4"><label><input name="fujian" id="fujian" type="file" class="file huge" /></label><?php if($Col_File != '' ): ?><a href="__SYSWEB__/Uploads/<?php echo ($Col_File); ?>" target="_blank">下载文件</a><?php else: endif; ?></td></tr><tr style="display:none" bgcolor="#F4F4F4"><td align="right">是否推荐：</td><td><input name="ColHot" type="checkbox" id="ColHot" value="1"   <?php if($Col_Hot == '1' ): ?>checked="checked"  <?php else: endif; ?> />推荐</td></tr><tr bgcolor="#F4F4F4"><td align="right" bgcolor="#F4F4F4">是否显示：</td><td bgcolor="#F4F4F4"><label><input name="ColState" type="checkbox" id="ColState" value="1" checked="checked"  <?php if($Col_State == '0' ): else: endif; ?>>            显示</label></td></tr><tr style="display:none" bgcolor="#F4F4F4"><td align="right">浏览次数：</td><td><input name="ColClick" type="text" class="input_3" id="ColClick" value="<?php echo ($ColClick); ?>" size="6" onkeypress="InputNum()" /></td></tr><tr bgcolor="#F4F4F4"><td align="right" bgcolor="#F4F4F4">发布日期：</td><td bgcolor="#F4F4F4"><input name="ColTime" type="text" class="input_3" id="ColTime" value="<?php echo ($col_time); ?>" size="10" onClick="WdatePicker()" /></td></tr><tr bgcolor="#F4F4F4"><td align="right">信息排序：</td><td><input name="ColOrder" type="text" class="input_3" id="ColOrder" value="<?php echo ($Col_Order); ?>" size="6" onKeyPress="InputNum()"><input name="ID" type="hidden" id="ID" value=""><input name="ffaids" type="hidden" value="<?php echo ($ffaids); ?>" /><input name="col_menuid" type="hidden" value="<?php echo ($col_menuid); ?>" /><input name="Save" type="hidden" id="Save" value=""></td></tr><tr id="Col_1" style="display:none"><td height="186" align="right" bgcolor="#F4F4F4">信息内容：</td><td bgcolor="#F4F4F4"><textarea name="content1" style="width:700px;height:200px;visibility:hidden;"><?php echo ($col_newsinfo["Col_Content"]); ?></textarea></td></tr><tr><td height="40" align="center" bgcolor="#E2EEE1"><label></label><label></label></td><td height="40" align="left" bgcolor="#E2EEE1"><label><input name="Submit" type="submit" class="Botton" id="Submit" value="<?php echo ($bvalue); ?>" />&nbsp; </label><label><input name="Submit3" type="reset" class="Botton" value="重置" /></label></td></tr></table></form></td></tr></table></body></html>