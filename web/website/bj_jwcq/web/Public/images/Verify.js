document.write("<div id='meizzCalendarLayer' style='POSITION: absolute; z-index: 9999; width: 144px; height: 195px; display: none'>");
...
{
      this.regInfo      = "Anbry日历控 关闭的快捷键：[Esc]";
      ...
      this.darkColor    = "#65AE51";      //控件的暗色
      this.lightColor = "#E2EEE1";      //控件的亮色
      this.btnBgColor = "#E6E6FA";      //控件的按钮背景色
      this.wordColor    = "#456F36";      //控件的文字颜色
      this.wordDark     = "#DCDCDC";      //控件的暗文字颜色
      this.dayBgColor = "#F5F5FA";      //日期数字背景色
      this.todayColor = "#65AE51";      //今天在日历上的标示背景色
...
function writeIframe()
{
      ...
      "      <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
           ...
           //"&nbsp;" +
           "<input style=' background-color: " + WebCalendar.btnBgColor +";cursor: hand; width: 96%; height: 100%;' onfocus='this.blur()'"+
      ...
      "      </td><td align=center><input name=today type=button value='当前日期' onfocus='this.blur()' style='width: 55' title='当前日期快捷键：T'"+
